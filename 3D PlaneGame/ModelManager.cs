...
namespace _3D_PlaneGame
{
    ...
    public class ModelManager : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public int missesLeft
        {
            get
            {
                return levelInfoList[currentLevel].missesAllowed - missedThisLevel;
            }
        }
        ...
        public void AddShot(Vector3 position, Vector3 direction)
        {
            shots.Add(new SpinningEnemy(
                ...
                , position, direction, 0, 0, MathHelper.PiOver4/40));
        }
        ...
        protected void CheckToSpawnEnemy(GameTime gameTime)
        {
            ...
            {
                if (levelInfoList[currentLevel].numberEnemies == enemiesThisLevel
                    && models.Count == 0)
                {
        ...
        private void SpawnEnemy()
        {
            ...
            Vector3 position = new Vector3(((Game1)Game).rnd.Next(
                ...
                ,((Game1)Game).rnd.Next(-(int)maxSpawnLocation.Y
                , (int)maxSpawnLocation.Y),maxSpawnLocation.Z);

            // Direction will always be (0, 0, Z), where
            // Z is a random value between minSpeed and maxSpeed
            Vector3 direction = new Vector3(0, 0, ((Game1)Game).rnd.Next(
            ...
            models.Add(new SpinningEnemy(
                Game.Content.Load<Model>(@"models\spaceShipOne")
        ...
        protected void UpdateModels()
        {
            ...
            for (int i = 0; i < models.Count; ++i)
            {
                ...
                ((Game1)Game).camera.cameraPosition.Z + 100)
                {
                    ...
                    ++missedThisLevel;
                    if (missedThisLevel > levelInfoList[currentLevel].missesAllowed)
                    {
                        ((Game1)Game).ChangeGameState(Game1.GameState.END, currentLevel);
                    }
                    models.RemoveAt(i);
                    --i;
                }
